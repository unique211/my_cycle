                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4><b>@lang('site_lables.Inquiry')</b></h4>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive" id="show_master">
                                    <table class="table-striped" id="laravel_crud" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>@lang('site_lables.Sr.No.')</th>
                                                <th>@lang('site_lables.Name')</th>
                                                <th>@lang('site_lables.Email')</th>
                                                <th>@lang('site_lables.Subject')</th>
                                                <th>@lang('site_lables.Message')</th>
...
<script type='text/javascript' src="{{ URL::asset('/resources/js/myjs/inquiry.js',true) }}"></script>
