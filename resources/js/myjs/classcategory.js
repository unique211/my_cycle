        ...
        $.get('getdesibleall_classcategory', function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (rights == 1) {
                    ...
                    if (st == 1) {
                        html += '<td id="user_id_' + data[i].classcategory_id + '"> 	<input type="checkbox" class="btnstatus" disabled  id="chekcstatus_' + data[i].classcategory_id + '" name="chekcstatus_' + data[i].classcategory_id + '" checked data-toggle="toggle"    data-on="Active" data-off="Inactive"  data-onstyle="success" data-offstyle="danger"  ></td>';
                    } else {
                        html += '<td id="user_id_' + data[i].classcategory_id + '"> 	<input type="checkbox" class="btnstatus"  disabled id="chekcstatus_' + data[i].classcategory_id + '" name="chekcstatus_' + data[i].classcategory_id + '"  data-toggle="toggle"    data-on="Active" data-off="Inactive"  data-onstyle="success" data-offstyle="danger"  ></td>';
                    }
